...
LUALIB_API void luaL_argcheck(lua_State* L, int cond, int arg, const char* extramsg); // Added missing function
LUALIB_API int luaL_newmetatable(lua_State* L, const char* tname); // Added missing function
